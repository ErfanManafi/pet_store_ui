                          ...
                          child: Column(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Text(
                                  'Bwealthest Small Dog Sleeveless Sweater.',
                ...
                child: Row(
                  ...
                  children: [
                    DelayedDisplay(
                        ...
                        slidingBeginOffset: const Offset(0, 10),
                        child: BottomPuppyCard(
                          lowerCardWidth: lowerCardWidth,
    ...
    return Bounce(
      ...
      child: Container(
          ...
          child: SvgPicture.asset(
            ...
            color: liked
                ? const Color.fromARGB(255, 204, 26, 79)
                : SolidColors.white,
            width: 12,
            height: 12,
          )),
